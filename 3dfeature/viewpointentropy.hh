#ifndef VIEWPOINTENTROPY_HH
#define VIEWPOINTENTROPY_HH
...
class ViewpointEntropy: public AbstractFeature<MeshT> {
public:
public:
    ViewpointEntropy(MeshT &in_mesh)
        : m_mesh(in_mesh), m_PropertyKeyword("Viewpoint Entropy")
    {
